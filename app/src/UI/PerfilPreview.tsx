...
const PerfilPreview = () => {
  ...
  return (
    <section className="sticky inset-x-0 bottom-0 border-t border-gray-100  flex flex-row justify-between items-center pr-8 rounded-bl-lg">
      <div className="flex items-center gap-2 bg-white p-4 rounded-bl-lg hover:bg-gray-50">
        <img
          alt=""
